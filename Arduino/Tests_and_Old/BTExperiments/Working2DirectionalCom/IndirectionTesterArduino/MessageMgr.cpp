...
const byte MessageMgr::inMsgLen     = 8,
           ...
           MessageMgr::nbRFuncs     = 7,
           MessageMgr::charCharLen  = 1,
           MessageMgr::intCharLen   = 2,
           MessageMgr::floatCharLen = 5;

const char MessageMgr::rFuncIndexVec[] = {'d','g','m','p','s','t','x'};
const rFuncPtr MessageMgr::rFuncVec[] = {&Indirectable::divV,
                                         &Indirectable::get,
                                         &Indirectable::minusV,
                                         &Indirectable::addV,
                                         &Indirectable::set,
...
char* MessageMgr::formatResponse(char* msg, float v){
  #ifdef DEBUG
  Serial.print("format response, v = ");
  Serial.println(v);
  #endif
